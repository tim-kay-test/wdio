Feature: Banked Payment Agreements
 ...
 Scenario Outline: As a user, I want to verify the successful payment for a delayed agreement
 ...
 Scenario Outline: As a user, I want to verify the failed payment due to Insufficient funds for an agreement
